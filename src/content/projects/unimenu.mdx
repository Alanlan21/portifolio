...
description: Sistema completo de pedidos para restaurantes. Autenticação JWT, integração Stripe para pagamentos, backend NestJS + frontend React + app React Native.
tags:
  - NestJS
  - React
  - React Native
...
highlight: Integração Stripe • JWT Auth • Cross-platform
date: 2023-08-20
---
...
- [Repositório GitHub](https://github.com/Alanlan21/unimenu)
